...
import {formatCurrency, formatNumber} from "../../format/format"
            ...
            <div className={styles.transactionDetailsContainer}>
                <div className={styles.detailRow}>
                    ...
                    <div className={styles.detailValue}>
                        ...
                        {" → "}
                        {formatAddress(
                            tx.transaction.inMessage?.info.dest,
                            contracts,
                            onContractClick,
                        )}
                    </div>
                        ...
                        <div className={styles.labeledSectionContent}>
                            <div className={styles.multiColumnRow}>
                                <div className={styles.multiColumnItem}>
                                    ...
                                    <div
                                        className={`${styles.multiColumnItemValue} ${styles.currencyValue}`}
                                    >
                                ...
                                <div className={styles.multiColumnItem}>
                                    ...
                                    <div
                                        className={`${styles.multiColumnItemValue} ${styles.numberValue}`}
                                    >
                ...
                <div className={styles.labeledSectionRow}>
                    ...
                    <div className={styles.labeledSectionContent}>
                        <div className={styles.multiColumnRow}>
                            <div className={styles.multiColumnItem}>
                                <div className={styles.multiColumnItemTitle}>
                                    Amount Sent (Total)
                                </div>
                                <div
                                    className={`${styles.multiColumnItemValue} ${styles.currencyValue}`}
                        ...
                        {computeInfo === "skipped" ? (
                            ...
                            <div className={styles.multiColumnRow}>
                                ...
                                <div className={styles.multiColumnItem}>
                                    ...
                                    <div
                                        className={`${styles.multiColumnItemValue} ${styles.gasValue}`}
                                    >
